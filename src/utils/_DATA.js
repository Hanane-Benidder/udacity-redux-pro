export let users = {
  ...
  tylermcginnis: {
    ...
    name: "Tyler McGinnis",
    avatarURL:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9qcl_uYPM2DjJL_WO1G5gCt5VNdKyN-KezA&usqp=CAU",
    answers: {
...
export function _saveQuestion(question) {
  return new Promise((res, rej) => {
    const loginUser = question.author;
    ...
    setTimeout(() => {
      ...
      users = {
        ...
        [loginUser]: {
          ...users[loginUser],
          questions: users[loginUser].questions.concat([formattedQuestion.id])
        }
      }
      ...
      questions = {
        ...
        [qid]: {
          ...
          [answer]: {
            ...
            votes: questions[qid][answer].votes.concat([loginUser]),
          },
        },
      };
